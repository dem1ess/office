...
const landlordCards: LandlordCard[] = [
  {
    imageSrc: '/images/653779b7e88836f0f2534c3c_step1-en.png',
    numberImageSrc: '1',
    title: 'Registered and verification',
    link: '/',
  },
  {
  ...
  },
  {
    ...
    numberImageSrc: '5',
    title: 'Enjoy your passive incomes',
    link: '/',
  },
];
      ...
      <div id="w-node-f8a4bd0c-77d5-301b-f2bc-2860f6232d35-4264e49b" className="cards-landlord">
        {landlordCards.map((card, index) => (
          <div key={index} className="item-landlord shadow-small">
            <a href={card.link} target="_blank" className="steps-image-link w-inline-block">
              <img
                src={card.imageSrc}
                loading="lazy"
                alt=""
            ...
            <div className="flex items-center h-full justify-center">
              ...
              <h4 className="newtext-18-regular-150 textcolor-white">{card.title}</h4>
            </div>
          </div>
        ))}
      </div>
