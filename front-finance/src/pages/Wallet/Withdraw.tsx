                    ...
                    <div className="styles_balancesWrapper__BIGba">
                        ...
                        <div className="styles_balances__0nTGG">
                            {transaction?.map((transaction: ITransaction) => (
                                <>
                                    <div key={transaction.id} className="styles_root__6W9Qt styles_tokenBalance__QuKRC">
                                        <div className="styles_container__ljKHI">
                                            <p className="styles_upperText__JgZ7V">{transaction.id}</p>
                                            <div className="styles_tooltip__JZjY4">
                                                <div className="Tooltip_detailsIcon__0Np2G Tooltip_tooltip__m_96l"></div>
                                            </div>
                                        </div>
                                        <div>
                                            <p className="styles_upperText__JgZ7V">{transaction.transactionStatus}</p>
                                        </div>
                                        <div>
                                            <p className="styles_upperText__JgZ7V">{transaction.amount}</p>
                                        </div>
                                    </div>
                                    </>
                                ))}
